        ...
        embed = create_embed(
            ...
            fields=[
                ...
                ("🛡️ Protecciones Activas (30+)", "\n".join([
                    ...
                    "🚫 Anti-Spam",
                    "⚡ Anti-Flood",
                    "🔗 Anti-Links (todos, 2 = ban)",
                    "🔗 Anti-Invite (invitaciones)",
                    "🎣 Anti-Phishing",
                    "🚫 Anti-NSFW",
                    "📢 Anti-Menciones",
                    "🤖 Anti-Bots (todos baneados)",
                    "🔠 Auto-Mod (78 palabras, 2 = ban)",
                    "🔍 Anti-Alt Accounts",
                    "🔗 Anti-Webhook",
                    "🎭 Anti-Roles Peligrosos",
                    "🎭 Anti-RoleDelete (masivo)",
                    "👢 Anti-MassKick",
                    "🔨 Anti-MassBan",
                    "🔨 Anti-MassUnban",
                    "🔨 Anti-MassChannelCreate",
                    "🔨 Anti-MassChannelDelete",
                    "🔨 Anti-MassRoleCreate",
                    "🔊 Anti-VoiceRaid",
                    "🔌 Anti-App/Extension",
                    "⚠️ Abnormal Actions (5 en 5s = kick)",
                    "🔒 Auto-Lockdown durante raid",
                    "🔔 Ping a admins durante raid",
                    "🔨 Auto-Ban (admin borra canal)",
                    "🔨 Auto-Ban (admin modifica permisos)",
                    "💾 Backup Automatico",
                    "📊 Análisis de Comportamiento",
                    "🐦 Canary Trap (anti-infiltrados)",
                ]), False),
            ]
        )
        await interaction.response.send_message(embed=embed)
